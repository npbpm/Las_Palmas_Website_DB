const words = {
  spanish: {
    ...
    dawnText2:
      "Este plan es especial para desconectarse del día a día con hospedaje para 2 personas, desayuno, almuerzo o cena y cabalgata de 1 hora a la peña de la virgen.",
    includes: "Incluye: ",
    breakfast: "Desayuno",
    lodging: "Hospedaje",
    ...
    restingText:
      "Este plan es perfecto para las personas que quieren despejar su mente, recargar de energía su espíritu disfrutando de una relación total con la naturaleza EN LAS PALMAS DE COCORA",
    ecoSeedTitle: "Plan Ecosemilla",
    arrival: "Recibimiento en el restaurante a las 9 am",
    hike: "Caminata ecológica (duración 2 horas)",
    comebakc: "Regreso al eco-hotel y Almuerzo",
    outdoor:
      "Actividades deportivas al aire libre - vóley verde - micro futbol",
    ...
    natureText:
      " El plan Naturaleza y Yo le brinda la oportunidad de que disfrutes de una hermosa cabalgata por el bosque de niebla permitiéndole apreciar las hermosas palmas de cera y el imponente morrogacho, el morro más alto del Quindío.",
    fogRide: "Cabalgata por el bosque de niebla",
    lunch: "Almuerzo en el restaurante",
    romanticTitle: "Plan Tardes de Romance",
    romanticText:
      "Este plan está dirigido especialmente para parejas, para que vivan una experiencia llena de amor y sorpresas , enamórate en LAS PALMAS DE COCORA",
  ...
  english: {
    ...
    dawnText1:
      "Let your spirit fly with a beautiful sunset between the green mountains and the wax palm trees in the Eco-Hotel Las Palmas.",
    dawnText2:
    ...
    arrival: "Arrival at the restaurant at 9 am",
    ...
    friendsTitle: "Package Friends Only",
    friendsText:
