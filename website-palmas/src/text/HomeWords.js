const words = {
  spanish: [
    ...
    },
    {
      title: "Hospedaje",
      description:
        "Viva una experiencia de paz, tranquilidad y armonía que le ofrece las palmas de cocora en su cabaña construida en madera rodeada de coloridas flores y palmas de cera. ¡El lugar perfecto para una escapada de un fin de semana!",
  ...
  english: [
    ...
    },
    {
      title: "Lodging",
      description:
        "Let yourself experience the peace, tranquility and harmony that the restaurant Las Palmas offers you with its wooden cabin in the middle of colourful flowers and wax palm trees. The perfect place for a weekend breakaway!",
      img: "./images/Cabin.jpeg",
      path: "/lodging",
    },
    {
